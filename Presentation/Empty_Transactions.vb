...
Public Class frmEmptyTransactions
    ...
    Private Sub btnClear_C_Click(sender As Object, e As EventArgs) Handles btnClear_C.Click
        Clear(pnCommissions)
        DisableControlls(pnCommissions)
        cmbAgent_C.Enabled = True
    End Sub

    Private Sub btnAddCommission_Click_1(sender As Object, e As EventArgs) Handles btnAddCommission.Click
        Call CommissionCheckValues()
    End Sub

    Private Sub btnCalculateLine_Click(sender As Object, e As EventArgs) Handles btnCalculateLine.Click
    ...
    Private Sub cmbAgent_C_DropDown(sender As Object, e As EventArgs)
        ...
        Dim BusinessLogic As New cnAgent
    ...
    'Private Sub dgvCommissions_CellContentClick(sender As Object, e As DataGridViewCellEventArgs) Handles dgvCommissions.MouseEnter
    '    Me.dgvCommissions.Enabled = True
    ...
    'Private Sub dgvTransactionLine_CellContentClick(sender As Object, e As DataGridViewCellEventArgs) Handles dgvTransactionLine.MouseEnter
    '    Me.dgvTransactionLine.Enabled = True
    '    Me.dgvTransactionLine.ReadOnly = True
    'End Sub
    ...
    Sub FinishCommission()
        ...
        If ans = MsgBoxResult.Yes Then
            For Each c As Control In pnCommissions.Controls
    ...
    Private Sub FormatTransactions()
        If dgvTransactionLine.RowCount > 0 Then
